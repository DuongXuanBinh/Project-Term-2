                    ...
                    <div class="row row-mt-15em">
                        ...
                        <form class="search-flight">
                            <div class="row mt-text animate-box" data-animate-effect="fadeInUp">
                                ...
                                <input type="text" class="col-md-6 form-control" placeholder="Enter flight number" required autofocus>
                                <input type="text" class="col-md-2 form-control" id="date-flight" placeholder="Departure Date" required>
