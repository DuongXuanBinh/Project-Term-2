                    ...
                    <div class="row row-mt-15em">
                        ...
                        <form class="search-flight" action="/flight-status/search">
                            <div class="row mt-text animate-box" data-animate-effect="fadeInUp">
                                ...
                                <input name="flight_id" type="text" class="col-md-6 form-control" placeholder="Enter flight number" required autofocus>
                                <input name="date" type="text" class="col-md-2 form-control" id="date-flight" placeholder="Departure Date" required>
                        ...
                        <div class="result-form mt-text animate-box" data-animate-effect="fadeInUp">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>{{date_format($flight->departure_date,'d/m/Y')}}</td>
                                    <td>{{date_format($flight->departure_date,'H:i')}}</td>
                                    <td>{{date_format($flight->arrival_date,'H:i')}}</td>
                                    <td>{{$status->string}}</td>
                                </tr>
                            </table>
                            </div>
