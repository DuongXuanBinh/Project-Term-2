...
<html>
		...
		<div class="gtco-container">
			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						<li><a href="destination.blade.php">Destination</a></li>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(../../../../../../Aptech/GitHub/Project-Term-2/dat/traveler-master/images/company-header3.jpg)">
		<div class="overlay"></div>
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12 col-md-offset-0 text-left" style="padding-top: 200px">
					<div class="row row-mt-15em">

						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Don't be shy</span>
							<h1 style="font-size: 80px">Get In Touch</h1>
						</div>
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
							...
							<li class="phone"><a href="tel://1234567920">1900 9999</a></li>
							<li class="email"><a href="mailto:info@yoursite.com">info@yoursite.com</a></li>
							<li class="url"><a href="https://freehtml5.co">helveticairline.epizy.com</a></li>
						</ul>
					</div>
