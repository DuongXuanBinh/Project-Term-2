...
<div class="container mail-page">
    ...
    <div class="row col-12">
        <p class="col-12">Dear our valued Customer, <br>
            We regret to inform you that your flight reference code AAAA has been delayed. The new schedule
            is shown below.</p>
    </div>
    <div class="row col-12">
        <p class="itinerary">NEW SCHEDULE DETAILS</p>
    </div>
    ...
    @endfor
    <div class="row col-12">
        <p>If there is any problem, please contact to our ground staff or hotline: 19009999</p>
    </div>
    <div class="row col-12">
        <p>Once again, we apologise for this inconvenience and look forward to see you onboard soon!</p>
    </div>
