...
<div class="container mail-page">
        ...
        <div class="col-8">
            <table>
                    ...
                    @for($i=0;$i<count($passengers);$i++)
                        @if($i>0)
                            <tr>
                                <td>{{$passengers[$i]->sex = 'Male' ? 'Mr. ' : 'Mrs/Ms. '}}{{strtoupper($passengers[$i]->lastname)}}/{{strtoupper($passengers[$i]->firstname)}}</td>
                            </tr>
                        @else
                        <tr>
    ...
    @if($way == 1 && count($flights)==1)
        @for($i = 0;$i<count($flights);$i++)
    <p><img src="https://lh3.googleusercontent.com/HDORnlEa6fzHozYGtBSwBnb3sXwLZ5A83ux1
    VuxqitdG805uge_X_dcHKVIJVF0KKQFipFZ6b6vaE2LHxFnaNWpZ_OPFmLFZArleMhDgD
    -_sCRRINIe8TeyPYwvDrP6zD-QNOPO4A_LxqRZvdbDrqvtjwp3EmmmAhEkzunU_UO73QG
    3648nYiY-CoKIOGS21vXmgvfyGdmQNiOQJH0DDQkWN7gmE3hxFi8EWVtj
    6S1e8DCrwtjMeNy9AUCswdfyiE0nAU-gxvUMgSfVF_7KHHJ_AEX9z9fzGycp4EcFe4t
    mx1H_wjMkBbHS_vOB90va_iFECWxraCQui7jZq7_q1Q6CC6RfLY6MTL97bhmqoVflnM0XzrPtRgVjBQark978c5
    b8QwnFrKW7tzBDxc9e4GDvcgvRqLdKe42a0RD5h62eezPCYnqOJvOtSJ0jSU1ZA8tqt-2gf9g7TlzLUgD72MrW3PmO
    Dy8v63NGDoLco1U3sJC1G4mx1K8YrSypAn-EJQE1JDasx1gEXCUlVoBevr3kCHPwiitlxPRLrgnYwwkJ2FlS5FBZb
    4XhPXFvNz4uQOGcdPo_Y8mzZrUixNs54eHs0kEW20COsjRVmLP-bJXPmpe6hVTlEELZBn4BxfLGzGIRX35
    P3GJH2dyoD6tL0ge70PdJZz4FSrbzm3g_p3wHkuPW_cNl4uhJl8y-KkxS3oGlSfHZ13Zn0ptm4DYQrT8Ei=s84
    -no?authuser=0" height="30" width="30"/> Departure: <span class="depart-date">{{date('F j,Y',strtotime($flights[$i]->departure_date))}}</span></p>
