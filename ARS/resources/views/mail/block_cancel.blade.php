...
<div class="container mail-page">
    ...
    <div class="row col-12">
        <p class="col-12">Dear Customer, your Heveltic Airline flight blocking has been <b>cancelled</b>. The detailed information is shown below</p>
    </div>
    <div class="row col-12">
