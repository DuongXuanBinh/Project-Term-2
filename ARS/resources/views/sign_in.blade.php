            ...
            <div class="row">
                <div class="col-md-12 mt-text">
                    ...
                    <form action="/sign-in/register" class="form-signup" method="post">
                        ...
                        <input name="email" type="email" id="su-email" class="form-control" placeholder="Email Address" required>

                        <svg style="position: absolute;top: 557px;left: 838px;display: none" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#09c5a9" class="bi bi-check2 su-email" viewBox="0 0 16 16">
                            <path d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z"/>
                        </svg>
