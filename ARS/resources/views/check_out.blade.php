...
<head>
    ...
    <link rel="stylesheet" href="../../../../../../Aptech/GitHub/Project-Term-2/dat/traveler-master/css/jquery-ui.css">
    <!--	dat style-->
    ...
    <![endif]-->
    <!--		jquery, jquery ui-->
    <script src="../../../../../../Aptech/GitHub/Project-Term-2/dat/traveler-master/js/jquery-3.6.0.js"></script>
    <script src="../../../../../../Aptech/GitHub/Project-Term-2/dat/traveler-master/js/jquery-ui.js"></script>
</head>
<body>
    ...
    <div class="gtco-container">
        <div class="row ">
            <div class="col-sm-4 col-xs-12 ">
                <div id="gtco-logo"><a href="index.html"><img class="img-responsive" src="../../../../../../Aptech/GitHub/Project-Term-2/dat/traveler-master/images/logo_1.png" alt=""></a></div>
            </div>
            <div style="padding-top: 1.5rem" class="pt-4 col-xs-8 text-right menu-1 ">
                <ul>
                    <li><a href="destination.blade.php">Book Flight</a></li>
...
<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(../../../../../../Aptech/GitHub/Project-Term-2/dat/traveler-master/images/HEL_Popup_Teaser_E22.jpg); height: 400px">
    <div class="overlay"></div>
    <div class="gtco-container">
        <div class="row">
...
<div class="gtco-container check_out">
    ...
    <div class="col-md-12 mt-text animate-box" style="padding: 0" data-animate-effect="fadeInUp">
        <div class="row" style="margin: 20px 0 20px;">
            <div class="col-md-9">
                <div class="row">
<!--                    <div class="col-md-12 seat-note">-->
<!--                        <span>Note:</span> <br>-->
<!--                        Helvetic Airline headquarter is located in Vietnam, banks issuing International payment cards can charge a commission fee on each foreign transaction, depending on the country and currency of the International payment cards.-->
<!--                        Helvetic Airline shall not be responsible for such fees. Please check with your issuing bank for details about commission fees.-->
                                ...
                                <div class="col-md-12 radio_choose radio_block">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9" style="margin-top: 15px">
                                            Your seat will be reserved until the purchase is made. According to our policy, you have to proceed purchase
                                            at least 2 weeks before departure unless your block seat will be automatically cancelled.
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <p style="margin-top: 15px">
                                                <img src="../../../../../../Aptech/GitHub/Project-Term-2/dat/traveler-master/images/Logo-VNPAYQR-update.png" width="150" alt="">
            ...
            <div class="col-md-3 flight_detail">
                <div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
                    <table>
                        ...
                        <tr>
                            <td>Ha Noi</td>
                            <td rowspan="2"><img src="../../../../../../Aptech/GitHub/Project-Term-2/dat/traveler-master/images/429706-84%20-%20Copy.png" alt=""></td>
                            <td>Ho Chi Minh</td>
                        </tr>
                        <tr>
                            <td>18:50</td>
    ...
    <div class="gtco-container">
        ...
        <div class="row copyright pt-0 ">
            ...
            <p class="col-md-7 col-md-push-2 row">
                <img class="mx-2 col-md-3" style="height: 118px !important; width: 150px!important;" src="../../../../../../Aptech/GitHub/Project-Term-2/dat/traveler-master/images/logo_5star_skytrax.png" alt="">
                <img class="mx-2 col-md-3" style="height: 118px; width: 150px" src="../../../../../../Aptech/GitHub/Project-Term-2/dat/traveler-master/images/logo_tripadvisor2020.png" alt="">
                <img class="mx-2 col-md-3" style="height: 118px; width: 150px" src="../../../../../../Aptech/GitHub/Project-Term-2/dat/traveler-master/images/logo_world_economy.png" alt="">
            </p>
